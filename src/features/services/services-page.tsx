    ...
    <main className="flex-1">
      <section className="mx-auto grid max-w-7xl gap-6 px-5 py-2 sm:px-8 lg:grid-cols-[1fr_0.82fr] lg:px-10 lg:py-4">
          <div className="editorial-float relative overflow-hidden rounded-[2rem] px-7 py-8 sm:px-10 sm:py-10 lg:px-14 lg:py-14">
            ...
            <p className="label-text mb-5 text-[var(--accent-lime)]">Services</p>
          ...
          <div className="surface-soft rounded-[2rem] p-7 sm:p-10">
            <p className="label-text text-[var(--secondary-dark-green)]">Included by default</p>
            <div className="mt-6 space-y-8">
              <p className="text-xl leading-8 tracking-[0.01em] text-[var(--on-surface-variant)]">
          ...
          <div className="surface-group rounded-[2rem] p-4 sm:p-6">
            <div className="grid gap-4 md:grid-cols-2">
              {services.map((service, index) => (
                ...
                >
                  <p className="label-text text-[var(--secondary-dark-green)]">Service 0{index + 1}</p>
                  <h2 className="mt-5 text-3xl font-semibold leading-tight tracking-[-0.02em] text-[var(--primary)]">
                    {service.name}
                  </h2>
